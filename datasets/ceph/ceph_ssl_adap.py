...
from torchvision.utils import save_image as torchvision_save
...
class Cephalometric(data.Dataset):
    def __init__(self, pathDataset, split="Train", size=384, patch_size=192,
        ...
        self._init_adap_transforms()

    def _init_adap_transforms(self):
