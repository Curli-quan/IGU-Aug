from .ceph_ssl import Cephalometric as basic_dataset
...
class Cephalometric(basic_dataset):
    def __init__(self, pathDataset, datatag=None, split='noise', *args, **kwargs):
        super().__init__(pathDataset=pathDataset, mode="Train", *args, **kwargs)
...
if __name__ == "__main__":
    ...
    dataset = Cephalometric(pathDataset=dirpath, datatag="NoisyTrainingData10")
