...
from datasets.ceph.ceph_noisy import Cephalometric
...
def train(logger, config):
    ...
    dataset_train = Cephalometric(config['dataset']['pth'], datatag="NoisyTrainingData05", patch_size=config['special']['patch_size'])
