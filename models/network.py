...
class UNet_Pretrained(nn.Module):
    def __init__(self, n_channels=3, n_classes=19, regression=False, two_d_softmax=False, finalc=64):
        ...
        self.up5 = Up(128, finalc, bilinear)
        ...
        self.final = nn.Conv2d(finalc, final_channel, kernel_size=1, padding=0) # align to ssl network
